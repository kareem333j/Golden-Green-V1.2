...
scrolling('.ser1', 'left', '500px', 500, false);
scrolling('.ser2', 'right', '500px', 500, false);
scrolling('.ser3', 'left', '500px', 600, false);
scrolling('.ser4', 'right', '500px', 600, false);
scrolling('.services .back1', 'right', '500px', 600, false);
scrolling('.services .back2', 'left', '500px', 600, false);

scrolling('.work-with-us .a1', 'left', '500px', 700, false);
scrolling('.work-with-us .a2', 'right', '500px', 700, false);

scrolling('.con1', 'left', '500px', 500, false);
scrolling('.con2', 'top', '500px', 700, false);
scrolling('.con3', 'right', '500px', 500, false);
scrolling('.send', 'bottom', '500px', 700, false);
scrolling('.send .map', 'left', '500px', 900, false);
scrolling('.send .form', 'right', '500px', 900, false);
